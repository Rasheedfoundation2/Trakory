...
const Chat: React.FC = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            // Update the selected room's timestamp in the sidebar without triggering notifications
            setChatRooms((prevRooms) => prevRooms.map((room) => (room.id === selectedRoom.id ? { ...room, updated_at: new Date().toISOString() } : room)));
        } catch (error) {
